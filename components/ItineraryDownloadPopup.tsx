...
export default function ItineraryDownloadPopup({ isOpen, onClose, packageName }: ItineraryDownloadPopupProps) {
          ...
          >
            ...
            {submitted ? (
              <div className="space-y-6 py-8 animate-in fade-in zoom-in duration-500">
                ...
                <h3 className="font-serif text-3xl text-forest uppercase tracking-widest">Sent Successfully</h3>
                <p className="text-stone font-sans text-sm leading-relaxed">
                  The full itinerary for <strong>{packageName}</strong> has been sent to your inbox.
                </p>
              </div>
            ) : (
              <div className="space-y-8">
                <div>
                  <span className="text-gold text-[10px] uppercase tracking-[0.4em] font-bold block mb-4">Request Detailed Itinerary</span>
                  ...
                  <p className="text-stone/70 font-sans text-sm leading-relaxed max-w-sm mx-auto">
                    Share your email to receive the FULL Itinerary to your inbox.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-left">
                  ...
                  >
                    {loading ? "Preparing Itinerary..." : "share itinerary"}
                  </button>
                  
                  <p className="text-[9px] text-stone/40 text-center uppercase tracking-widest">
                    Your details are safe with us. We only send requested travel info.
                  </p>
                </form>
              </div>
            )}
