...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#07130d]">
      ...
      {/* ── NAV GRID + NEWSLETTER ── */}
      <div className="border-t border-gold/15">
        <div className="max-w-6xl mx-auto px-6 md:px-16 py-14 grid grid-cols-2 md:grid-cols-[1.6fr_1fr_1fr_1fr] gap-10 md:gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-cream/30 text-[9px] font-sans tracking-wide mb-5">
            ...
            <form className="flex mb-7">
              <input
                ...
                className="flex-1 min-w-0 bg-white/5 border border-white/10 text-cream placeholder-cream/20 px-3 py-2.5 text-[11px] font-sans focus:outline-none focus:border-gold/40 transition-colors"
              />
              <button
                type="submit"
                className="bg-gold hover:bg-[#b8933a] text-[#07130d] font-sans text-[8px] uppercase tracking-[0.2em] px-4 py-2.5 transition-colors font-bold shrink-0"
              >
                Subscribe
              </button>
            </form>
            ...
            <div className="flex items-center gap-2.5">
              <a href="https://www.instagram.com/tilengasafaris_travel/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="w-8 h-8 border border-cream/15 flex items-center justify-center text-cream/35 hover:border-gold hover:text-gold transition-all duration-300">
              ...
              <a href="https://wa.me/256789390350" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                className="w-8 h-8 border border-cream/15 flex items-center justify-center text-cream/35 hover:border-gold hover:text-gold transition-all duration-300">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              {["Uganda", "Kenya", "Tanzania", "Rwanda", "South Africa", "Dubai"].map((d) => (
                <li key={d}>
                  <Link href={`/destinations/${d.toLowerCase().replace(" ", "-")}`}
