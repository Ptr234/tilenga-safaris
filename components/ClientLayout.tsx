...
export default function ClientLayout({
  ...
  useEffect(() => {
    const showDuration = 60 * 1000; // 60 seconds
    const hideDuration = 4 * 60 * 1000; // 4 minutes
    ...
    // Initial show
    let hideTimeout = toggleVisibility();

    // Start cycle
    const interval = setInterval(() => {
      hideTimeout = toggleVisibility();
