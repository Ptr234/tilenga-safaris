...
const services = [
  ...
  },
  {
    ...
    image: `${base}/Newstock/mothernbabyelephant.jpg`,
    tag: "Logistics"
  },
  {
    num: "06",
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-6">
              <div className="film-frame h-56">
                <img src={`${base}/gorrilas/gorrillas.jpg`} alt="Uganda gorilla" className="w-full h-full object-cover" />
              </div>
              <div className="film-frame h-56 mt-12">
                <img src={`${base}/Newstock/girrafe.jpg`} alt="African Wildlife" className="w-full h-full object-cover" />
              </div>
            </div>
            <div className="film-frame h-64">
              <img src={`${base}/gorrilas/gorrillas3.jpg`} alt="Gorillas in mist" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
