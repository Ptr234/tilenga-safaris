...
const hotspots = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=900&q=85",
  },
  {
    name: "Table Mountain",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?w=900&q=85",
  },
];
    ...
    <>
      ...
      <section className="grain-overlay relative h-[80vh] min-h-[500px] overflow-hidden flex items-end">
        <div
          ...
          style={{
            backgroundImage: `url(${base}/photos/newstock/Table%20Mountain.jpg)`,
        ...
        <div className="relative z-10 px-6 md:px-16 pb-16 max-w-3xl">
          ...
          <h1 className="font-serif text-6xl md:text-8xl text-cream mb-3 leading-none">
            <SplitText text="South Africa" by="char" stagger={0.04} delay={0.2} />
          </h1>
          <FadeIn direction="up" delay={0.5}>
            <p className="font-serif italic text-2xl text-gold">A World in One Country</p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="bg-forest py-6">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-cream/70 text-sm font-sans">
          ...
          <div>
            <span className="block text-gold text-xs uppercase tracking-widest mb-1">Airports</span>
      ...
      <section className="bg-cream py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <FadeIn direction="left">
            ...
            <h2 className="section-heading mb-6">Diversity Beyond Imagination</h2>
            <div className="w-12 h-0.5 bg-gold mb-8" />
            <p className="text-stone font-sans leading-relaxed mb-4">
              South Africa is a destination of staggering variety — a place where you can go from a world-class vineyard to a wild savanna within hours, and where the rugged Atlantic meets the warm Indian Ocean.
            </p>
            <p className="text-stone font-sans leading-relaxed mb-4">
              Cape Town, often voted the world&apos;s most beautiful city, is defined by the iconic Table Mountain and its stunning coastline. Just a short drive away, the Cape Winelands offer gourmet experiences in landscapes of rolling green mountains.
            </p>
            <p className="text-stone font-sans leading-relaxed">
              In the north, the Greater Kruger ecosystem provides one of the world&apos;s most dense concentrations of wildlife, home to all the Big Five and renowned for its luxury private lodges and expert field guides.
            </p>
          </FadeIn>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <ImageReveal direction="bottom" delay={0.18} className="overflow-hidden">
              <img
                src={`${base}/photos/newstock/splendifd.jpg`}
      ...
      <section className="bg-forest-dark py-20">
        <FadeIn direction="up" className="px-6 md:px-16 mb-10">
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-cream">
            <SplitText text="The Full Spectrum of Africa" by="word" stagger={0.06} />
          </h2>
        </FadeIn>
      ...
      <section className="bg-cream py-24 px-6 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <FadeIn className="mt-20 p-8 border border-gold/20 bg-forest-dark/5 text-center">
            <h4 className="font-serif text-2xl text-forest mb-4">Discover the Rainbow Nation</h4>
            <p className="text-stone font-sans text-sm mb-6 max-w-2xl mx-auto">
              We provide several other South Africa itineraries, including luxury rail journeys, shark cage diving adventures, and coastal explorations through the Garden Route. All tours can be delivered upon request and custom tailored.
            </p>
      ...
      <section className="bg-forest py-20 px-6 md:px-16 text-center">
        <FadeIn direction="up">
          <h2 className="font-serif text-3xl md:text-5xl text-cream mb-6">Ready to Explore South Africa?</h2>
          <p className="text-cream/60 font-sans max-w-lg mx-auto mb-10">
            From the peak of Table Mountain to the lions of Kruger — let us design your perfect South Africa itinerary.
          </p>
          <Link href="/plan-a-trip" className="btn-outline">Tailor My South Africa Trip</Link>
        </FadeIn>
      </section>
