...
const packages = [
  ...
  },
  {
    ...
    description:
      "Experience the raw power of Murchison Falls and the prolific wildlife of Queen Elizabeth NP — elephants, lions, and the famous tree-climbing lions of Ishasha.",
    activities: [
      "Game drives",
  ...
  },
  {
    ...
    description:
      "Journey into Bwindi Impenetrable National Park for a life-changing hour with mountain gorilla families — the most sought-after wildlife encounter in Africa.",
    activities: [
  ...
  },
  {
    ...
    tagline: "Complete Uganda discovery",
    duration: "8 Days",
    price: "From $3,000+",
    description:
      "The complete Uganda experience — gorillas in Bwindi, chimps in Kibale, the Big Five in Queen Elizabeth, and the thundering beauty of Murchison Falls.",
    activities: [
      "Gorilla trekking",
      "Chimp tracking",
      "Game drives",
  ...
  },
  {
    ...
    price: "From $2,000+",
    description:
      "Summit the legendary Mountains of the Moon with glaciers, giant heathers, and breathtaking Albertine Rift Valley panoramas.",
    activities: [
      "Mountain trekking",
      "Alpine glacier visit",
      "Equatorial forest walk",
      "Village visit",
    ],
  ...
  },
  {
    ...
    tagline: "Extended gorilla wellness stay",
    duration: "4 Days",
    price: "From $3,000 / person",
    description:
      "An extended gorilla experience with time to explore Bwindi’s forest trails, visit the Batwa pygmies, and acclimate to the montane environment.",
    activities: [
      "2x gorilla trek options",
      "Batwa trail",
