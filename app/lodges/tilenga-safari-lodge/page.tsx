...
const rooms = [
  {
    ...
    count: "15 Units",
    description: "Located at the property edge with stunning sunrise and sunset views over the Albert Nile. Each cottage features a wide private balcony, indoor bathroom, and electric mosquito repellent — a perfect blend of bush comfort and contemporary style.",
  ...
  },
  {
    ...
    count: "11 Units",
    description: "Designed for families and groups — 3-in-1 cottages with twin and single beds, and balconies large enough to seat up to 8 people. Ideal for group gatherings at sunrise over the Nile.",
...
export default function TilengaSafariLodgePage() {
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] overflow-hidden flex items-end">
        ...
        <div className="relative z-10 px-8 md:px-20 pb-20 max-w-3xl">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-cream leading-none mb-4">
            Tilenga<br /><em className="not-italic italic text-gold">Safari Lodge</em>
          </h1>
        ...
        {/* Quick facts — bottom right overlay */}
      ...
      <section className="bg-cream grid md:grid-cols-2 min-h-[70vh]">
        ...
        <div className="flex flex-col justify-center px-8 md:px-16 py-20">
          ...
          <p className="text-stone font-sans leading-relaxed mb-10 text-sm">
            ...
            cuisine blends Ugandan flavors with international cooking — all with a sunset Nile view.
          </p>
        ...
        <div className="grid grid-cols-2 gap-1.5 p-1.5">
          <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&q=80" alt="Lodge" className="w-full h-56 md:h-full object-cover" />
          <div className="flex flex-col gap-1.5">
            <img src="https://images.unsplash.com/photo-1559827291-72ee739d0d9a?w=400&q=80" alt="Falls" className="w-full h-28 object-cover flex-1" />
            <img src="https://images.unsplash.com/photo-1547970810-dc1eac37d174?w=400&q=80" alt="Wildlife" className="w-full h-28 object-cover flex-1" />
            <img src="https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400&q=80" alt="Nile" className="w-full h-28 object-cover flex-1" />
          </div>
        </div>
      </section>
      ...
      {/* Activities — magazine numbered grid */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-0">
            {activities.map((act, i) => (
              <div
                key={act.name}
                className="group py-7 border-t border-gold/15 hover:border-gold/40 transition-colors duration-300"
              >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <ul className="space-y-5 mb-10">
              {[
                { label: "Phone", value: "+256 789 390 350 / +256 703 999 688", href: "tel:+256789390350" },
