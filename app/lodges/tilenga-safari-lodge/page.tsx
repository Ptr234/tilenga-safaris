...
const activities = [
  {
    name: "Game Drives",
    desc: "Guided morning and evening drives through Murchison Falls NP — elephants, giraffes, lions, buffaloes, and hippos.",
  },
  {
    name: "Murchison Falls Hike",
    desc: "Trek to the top of Africa's most powerful waterfall — 45 metres of the Nile squeezed through a 7-metre gorge.",
  },
  {
    ...
    <>
      ...
      <section className="bg-forest-dark overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          {[
            {
              src: `${base}/photos/tilengasafarilodge/insideview.png`,
            ...
            {
              src: `${base}/photos/tilengasafarilodge/tilengasafarislodge lunch close setup.png`,
              alt: "Lunch Detail",
              label: "Culinary Details",
              sub: "Crafted with care",
            },
            {
              src: `${base}/photos/tilengasafarilodge/tilengasafarislodge swimmingpool view2.png`,
              alt: "Pool View",
              label: "The Blue Hour",
              sub: "Pool · Afternoon",
            },
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <FadeIn direction="left">
            ...
            <ul className="space-y-5 mb-10">
              {[
                ...
                {
                  label: "Phone 2",
                  value: "+256 703 999 688",
                  href: "tel:+256703999688",
                },
                {
                  label: "Email",
                  value: "booking@tilengasafarilodge.com",
                  href: "mailto:booking@tilengasafarilodge.com",
                },
                {
                  label: "Location",
                  value: "Northern park boundary, Murchison Falls NP, Uganda",
                },
              ].map((item) => (
                <li key={item.label} className="flex gap-4 text-sm">
                  <span className="text-gold/60 uppercase tracking-widest text-[10px] font-sans w-20 shrink-0 pt-0.5">
                    {item.label}
                  </span>
                  {item.href ? (
                    <a
          ...
          <FadeIn direction="right" delay={0.2}>
            <div className="bg-forest-dark/60 border border-white/10 p-10">
              ...
              <p className="text-cream/40 font-sans text-xs uppercase tracking-widest mb-8">
                Response within 24 hours
              </p>
              <p className="text-cream/60 font-sans text-sm leading-relaxed mb-8">
                Share your travel dates and we&apos;ll come back with
                availability, current rates, and a tailored proposal.
              </p>
