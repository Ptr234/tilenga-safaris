...
export default function TilengaSafariLodgePage() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
            ...
            <FadeIn direction="left">
              <div className="flex items-center gap-4 mb-8">
                ...
                <p className="section-label text-gold">Reserve Your Stay</p>
              </div>
      ...
      {/* ── RESNOVA WIDGET ── */}
      <section className="bg-white py-12 px-6 md:px-24 lg:px-48">
        <div className="max-w-2xl mx-auto">
          <ResNovaWidget widgetId="a145daf2-9f0a-48ef-bb89-89c56187884b" />
        </div>
      </section>
    </>
  );
