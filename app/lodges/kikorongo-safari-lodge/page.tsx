...
const activities = [
  {
    name: "Kazinga Channel Cruise",
    desc: "Sail the 40km channel between Lake Edward and Lake George — home to the world's greatest concentration of hippos, Nile crocodiles, and 600+ bird species.",
  },
  {
    name: "Game Drives",
    desc: "Track lions, elephants, buffaloes, leopards, and the famous tree-climbing lions of Ishasha sector on guided morning and evening drives.",
  },
  {
    name: "Bird Watching",
    desc: "Over 600 bird species — including shoebill storks, African skimmers, and the rare martial eagle — right on the lodge doorstep.",
  },
  {
    name: "Rwenzori Climbing",
    desc: "The legendary Mountains of the Moon — Africa's third-highest peak with equatorial glaciers, giant heathers, and stunning Albertine Rift views.",
  },
  {
    name: "Lake Kikorongo Sunset",
    desc: "Evening boat cruises on Lake Kikorongo with spectacular sunsets over the Rwenzori Mountains and prolific birdlife.",
  },
  {
    name: "Chimpanzee Tracking",
    desc: "Kibale National Park, just 3 hours away, offers one of Africa's finest chimpanzee tracking experiences.",
  },
];
    ...
    <>
        ...
        <div className="bg-cream flex flex-col justify-center px-6 md:px-16 py-12 md:py-20 order-2 md:order-1">
          <FadeIn direction="left">
            ...
            <p className="text-stone font-sans leading-relaxed mb-4 text-sm">
              Situated directly on the Equator on a steep hill in Kasese,
              Kikorongo Safari Lodge looks out over the glistening waters of
              Lake George and Lake Kikorongo — with the snow-capped Rwenzori
              Mountains on the horizon.
            </p>
            <p className="text-stone font-sans leading-relaxed mb-4 text-sm">
              The lodge is the perfect base for exploring all that Queen
              Elizabeth NP has to offer — from the legendary Kazinga Channel
              boat safari to tracking tree-climbing lions in Ishasha.
            </p>
            <p className="text-stone font-sans leading-relaxed mb-10 text-sm">
              Guests describe a profoundly peaceful atmosphere — morning bird
              song, cool mountain air, and the lakes shimmering gold at sunset
            ...
            <div>
              <FadeIn direction="left">
                ...
                <p className="text-stone font-sans text-base leading-relaxed mb-10">
                  From tracking lions across the savannah to watching hippos
                  from a private boat on the Kazinga Channel, Kikorongo provides
                  an unfiltered gateway to Uganda&apos;s most diverse ecosystem.
                </p>
      ...
      <section className="bg-forest-dark overflow-hidden">
        ...
        <div className="overflow-hidden pointer-events-none select-none opacity-[0.025]">
          <p className="font-serif text-[20vw] whitespace-nowrap uppercase tracking-tighter text-cream">
            Kikorongo
          </p>
        </div>
      </section>
              ...
              <FadeIn direction="left">
                ...
                <div className="mt-12 bg-forest-dark p-8 text-cream">
                  ...
                  <p className="font-sans text-sm leading-relaxed text-cream/60">
                    Kikorongo Safari Lodge is perched on a high ridge. While the
                    views are unmatched, the paths between cottages can be
                    steep. Please inform us if you require a cottage with easier
                    access.
                  </p>
                </div>
              </FadeIn>
              ...
              <FadeIn direction="up">
                ...
                <div className="space-y-8 mb-12">
                  {[
                    {
                      label: "Phone",
                      value: "+256 789 390 350",
                      href: "tel:+256789390350",
                    },
                    {
                      label: "Phone 2",
                      value: "+256 775 69 2334",
                      href: "tel:+256775692334",
                    },
                    {
                      label: "Email",
                      value: "bookings@kikorongosafarilodge.com",
                      href: "mailto:bookings@kikorongosafarilodge.com",
                    },
                    {
                      label: "Web",
                      value: "www.kikorongosafarilodge.com",
                      href: "https://www.kikorongosafarilodge.com",
                    },
                  ].map((contact) => (
                    <div key={contact.label}>
                      ...
                      <a
                        href={contact.href}
                        className="font-serif text-xl text-forest hover:text-gold transition-colors break-all"
                      >
                        {contact.value}
                      </a>
                    </div>
